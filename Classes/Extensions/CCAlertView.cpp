...
//	button2->setOpacity(180);
    ...
    CCLabelTTF *titleLabel = CCLabelTTF::create(_title, FONT_COMMON_STD, 70);
    ...
    CCLabelTTF *messageLabel = CCLabelTTF::create(_message, FONT_COMMON_STD, 40, CCSizeMake(alertViewSprite->getContentSize().width - 50 * SCALE, 0), kCCTextAlignmentCenter);
    ...
    CCLabelTTF *cancelLabel = CCLabelTTF::create(_cancel, FONT_COMMON_STD, 18);
    ...
    CCLabelTTF *OKlabel = CCLabelTTF::create(_ok, FONT_COMMON_STD, 18);
